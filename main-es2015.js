...
let CareerBotFormComponent = class CareerBotFormComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CareerTopFormComponent = class CareerTopFormComponent {
    constructor(fb, mail) {
        this.fb = fb;
        this.mail = mail;
        this.sended = false;
...
CareerTopFormComponent.ctorParameters = () => [
...
let HeroComponent = class HeroComponent {
    ...
    ngOnInit() {
        const mySiema = new siema__WEBPACK_IMPORTED_MODULE_2___default.a({
            selector: '.siema',
            perPage: 1,
            duration: 1200,
            loop: true
...
let OsHakkindaComponent = class OsHakkindaComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ButtonHizmetComponent = class ButtonHizmetComponent {
    constructor() { }
    ngOnInit() {
    }
};
